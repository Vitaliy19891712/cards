...
import s from './cardsTableHeader.module.scss'
...
type TableHeaderPropsType = Omit<
  ...
  'children'
>
export const CardsTableHeader: React.FC<TableHeaderPropsType> = ({ columns, onSort, sort }) => {
    ...
    <thead>
      <tr className={s.header}>
        {columns.map(c => {
          ...
          return (
            <CardsTableCell as={'th'} key={c.key} onClick={handleSort(c.key, c.isSortable)}>
